...
inline void
Clamp(u32 *Value, u32 Minimum, u32 Maximum)
{
    if(*Value < Minimum)
    {
        *Value = Minimum;
...
Invert(matrix *M)
{
    ...
    Result.m21 = -(((num5 * num22) - (num4 * num20)) + (num2 * num18)) * num;
    Result.m31 =  (((num5 * num21) - (num4 * num19)) + (num3 * num18)) * num;
    ...
    Result.m02 =  (((num4 * num35) - (num3 * num34)) + (num2 * num33)) * num;
    Result.m12 = -(((num5 * num35) - (num3 * num32)) + (num2 * num31)) * num;
    Result.m22 =  (((num5 * num34) - (num4 * num32)) + (num2 * num30)) * num;
    Result.m32 = -(((num5 * num33) - (num4 * num31)) + (num3 * num30)) * num;
    ...
    Result.m03 = -(((num4 * num29) - (num3 * num28)) + (num2 * num27)) * num;
    Result.m13 = (((num5 * num29) - (num3 * num26)) + (num2 * num25)) * num;
    Result.m23 = -(((num5 * num28) - (num4 * num26)) + (num2 * num24)) * num;

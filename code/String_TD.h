...
inline i32 FirstOccurrenceOfCharInString(u8 CharToFind, u8 *String, u8 Delimiter);
inline i32 LastOccurrenceOfCharInString(u8 CharToFind, u8 *String, u8 Delimiter);
inline u32 StringLengthUntilChar(u8 *Character, u8 Delimiter);
inline u32 CopyStringUntilChar(u8 *Dest, u8 *Source, u8 Delimiter);
inline void CopyString(u8 *Dest, u8 *Source);
...
inline i32
FirstOccurrenceOfCharInString(u8 CharToFind, u8 *String, u8 Delimiter)
{
    i32 Result = -1;
    i32 Counter = 0;
    while(*String != Delimiter)
...
inline i32
LastOccurrenceOfCharInString(u8 CharToFind, u8 *String, u8 Delimiter)
{
    i32 Result = -1;
    i32 Counter = 0;
    while(*String != Delimiter)
